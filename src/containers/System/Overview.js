...
class Overview extends Component {
    ...
    handleChangeTypeChart = (event) => {
        this.setState({
            typeChart: event.target.value
        })
    }
    ...
    render() {
        let { sales, revenue, timeSales, timeRevenue, numberOrder, typeChart } = this.state;
                    ...
                    <div className='row'>
                        <div className='col-md-12 col-lg-6'>
                            <div className='row custom-gutter'>
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className='col-12'>
                                            <div className='text-center'>
                                                <button className='btn-sm m-1 btn-warning'>Chi tiết</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='col-md-11 mt-3 container-item '>
                                    <div className='m-1 text-left title'>Số đơn hàng chưa duyệt: {numberOrder}</div>
                                    <div className='m-1 text-left title'>Số đơn hàng đã duyệt: {numberOrder}</div>
                        ...
                        <div className='col-md-12 col-lg-6'>
                            <div className='row custom-gutter'>
                                <div className='col-md-12 container-item'>
                                    ...
                                    <div className='optionChart'>
                                        ...
                                        <div className='type-chart'>
                                            <Form.Select className='form-control col-3 m-3' value={typeChart} onChange={(event) => this.handleChangeTypeChart(event)}>
                                ...
                                <div className='col-md-12 mt-5 container-item'>
                                    ...
                                    <div className='optionChart'>
                                        <Form.Select className='m-3' value={timeRevenue} onChange={(event) => this.handleChangeTimeRevenue(event)}>
                                            <option value="Hôm nay">Hôm nay</option>
                                            <option value="Tuần này">Tuần này</option>
                                            <option value="Tháng này">Tháng này</option>
                                            <option value="Năm này">Năm này</option>
